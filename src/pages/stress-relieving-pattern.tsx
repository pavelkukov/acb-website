...
export default function PrivacyPolicy(): React.ReactElement {
    return (
        <Layout>
            ...
            <p>
                Perfection. Take your time and get it perfect. Be creative. The
                pleasure comes from the act itself. And the ideas it raises for
                you. Kids Love the process. And the color. Adults are not
                different in nature. You will feel good. And if you know this is
                for you, you have all the motivation you need to keep doing it.
            </p>
            <p>
                I learned this a long time ago. A young woman was complaining to
                me about her lack of inspiration for her art. I said something
                like, &quot;What are you so frustrated about? Art isn&#39;t just
                about the satisfaction of seeing something you&#39;ve created.
                It&#39;s about having something you want to see. Art is a joy,
                and it doesn&#39;t have to be a triumph. Art is something to do
                after you&#39;ve learned how to smile at other people and play.
            </p>
        </Layout>
    )
}

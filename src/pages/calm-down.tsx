...
export default function PrivacyPolicy(): React.ReactElement {
    return (
        <Layout>
            ...
            <h3 id="calm-the-f-ck-down">Calm down and be happy!</h3>
            <p>
                ...
                future! This book is similar to meditation, a beautiful little
                coloring book about being selfish and optimistic (and how that
                can be a really good thing). Like into meditation, the act of
                coloring explores a variety of themes, and there are plenty of
                ideas that could be useful for you and others.
            </p>
            <p>

...
export default function PrivacyPolicy(): React.ReactElement {
    return (
        <Layout>
            ...
            <p>
                CodeIterator is committed to ensuring that the app is as useful
            ...
            <p>
                The Adults Coloring Books app stores and processes personal data
                ...
                security features and it could mean that the Adults Coloring
                Books app won’t work properly or at all.
            </p>{' '}
            <div>
                <p>
            ...
            <p>
                Along the same lines, CodeIterator cannot always take
                ...
                and you can’t turn it on to avail the Service, CodeIterator
                cannot accept responsibility.
            </p>{' '}
            <p>
                With respect to CodeIterator’s responsibility for your use of
                ...
                CodeIterator accepts no liability for any loss, direct or
            ...
            <p>
                ...
                CodeIterator does not promise that it will always update the app
            ...
            <p>These terms and conditions are effective as of 2020-04-25</p>{' '}
            <p>
                <strong>Contact Us</strong>
            </p>{' '}
            <p>
                If you have any questions or suggestions about our Terms and
                Conditions, do not hesitate to contact us at Pavel Kukov
                &lt;pavelkukov@gmail.com&gt;.
            </p>
